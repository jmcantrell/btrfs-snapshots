...
export TEXT_PROFILE_VARIABLE_NOT_SET="Invalid profile: %q (%s is not set)"
export TEXT_PROFILE_PATH_NOT_ABSOLUTE="Invalid profile: %q (%s must be an absolute path)"
export TEXT_PROFILE_SNAPSHOTS_NOT_UNIQUE="Invalid profile: %q (SNAPSHOTS is not unique)"
export TEXT_PROFILE_SUBVOLUME_MISSING="Skipping profile: %q (subvolume is not available: %q)"
export TEXT_PROFILE_LOAD_FAILED="Unable to load profile: %q"
export TEXT_DEFAULTS_SNAPSHOTS_MISSING_PLACEHOLDER="Invalid defaults: %q (SNAPSHOTS is missing the %%s placeholder)"
